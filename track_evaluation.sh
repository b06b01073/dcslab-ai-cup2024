...
do
    ...
    do
        ...
        echo python main.py -f IMAGE/$date -l LABEL/$date --$param $i --out aicup_ts/labels/"${date}_${param}_${i}" --visualize $visualize --cam $cam --finetune True
        python main.py -f IMAGE/"${date}" -l LABEL/"${date}" --$param $i --out aicup_ts/labels/"${date}_${param}_${i}" --visualize $visualize --cam $cam --finetune True
