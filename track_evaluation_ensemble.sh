...
do
    ...
    do
        ...
        do
            ...
            echo python ensemble.py -f IMAGE/$date -l LABEL/$date --$param $i --out aicup_ts_ensemble/labels/"${date}_${param}_${i}" --visualize $visualize --cam $cam --dist_dir dist_matrix --finetune True
            python ensemble.py -f IMAGE/$date -l LABEL/$date --$param $i --out aicup_ts_ensemble/labels/"${date}_${param}_${i}" --visualize $visualize --cam $cam --dist_dir dist_matrix --finetune True
...
do
    ...
    do
        echo
        python calculate_ave_performance.py -f ts_result_ensemble/ -p "${param}" --start $start --end $end --step $step --cam $cam
    done
done